...
var questionsJSON = [
    {
        ...
        inputType: "choice",
        options: ["agree", false],
        optionsText: ["I Agree & understand, let's get started!", "Terms of Service & Agreement"],
...
function qualifiedCand() {
    ...
    // Generate message
    var candidateMessage = '<h4 style="color:black;">"Congratulations" You are a candidate for treatment.</h4>';
...
function createDate() {
    ...
    var years = ["Year","2012", "2011", "2010", "2009", "2008", "2007", "2006", "2005", "2004", "2003", "2002", "2001", "2000", "1999", "1998", "1997", "1996", "1995", "1994", "1993", "1992", "1991", "1990", "1989", "1988", "1987", "1986", "1985", "1984", "1983", "1982", "1981", "1980", "1979", "1978", "1977", "1976", "1975", "1974", "1973", "1972", "1971", "1970", "1969", "1968", "1967", "1966", "1965", "1964", "1963", "1962", "1961", "1960", "1959", "1958", "1957", "1958", "1956", "1955", "1954", "1953", "1952", "1951", "1950", "1949", "1948", "1947", "1946", "1945", "1944", "1943", "1942", "1941", "1940", "1939", "1938", "1937", "1936", "1935", "1934", "1933", "1932", "1931", "1930", "1929", "1928", "1927", "1926", "1925", "1924", "1923", "1922", "1921", "1920", "1919", "1918", "1917", "1916", "1915", "1914", "1913", "1912", "1911", "1910", "1909", "1908", "1907", "1906", "1905", "1904", "1903", "1902", "1901", "1900"];
    ...
    var selectTag1 = $(`<select id='dob-month-picker'>`);
    var selectTag2 = $(`<select id='dob-day-picker'>`);
    var selectTag3 = $(`<select id='dob-year-picker'>`);
    // Iterate through the array of options
    ...
    $(".schedule-row").append(columnOne, columnTwo, columnThree);
    // Next button
    var buttonTag = $("<button>").attr({ "class": "choice-button", "onclick": `submitDate()` }).text("Next");
...
function submitAnswer(inputId, index) {
    ...
    if (submittedValue === "") {
        ...
        if (!correctAnswer) {// Phone validation
            if (questionsJSON[questionIndex].validation == "phone") {
                if (submittedValue.length < 12) {
                    $('#question-alert').text("Please fill out your complete 10 digit phone number.");
                    return;
                } else {
                    // Empty the #questions div
                    $("#question").empty();
...
function submitDate() {
    ...
    var year = $('#dob-year-picker').val().toString(),
        month = $('#dob-month-picker').val().toString(),
        day = $('#dob-day-picker').val().toString();
    // Make sure fields filled out correctly
    if ((year === "Year" || month === "Month" || day === "Day") || (year === "" || month === "" || day === "")) {
...
function displaySchedule() {
    ...
    var subTitle = $('<h4>').text('Book your $39 appointment (similar to an in-office co-pay) below and the doctor will call you directly at your requested day/time. If approved for a prescription, you will receive your first 8 weeks of Addyi FREE (a $50 value).');
